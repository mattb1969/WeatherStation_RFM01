...
uint16_t  cmd_wakeup;
	...
	// Enviroment
	uint16_t cmd_config = CMD_CONFIG|BAND_433|LOAD_CAP_12C0|BW_134; // Tony
...
//	send_command16(fd, cmd_dcycle);			// CMD_LOWDUTY|0x00
	...
	cmd_config = CMD_CONFIG|cmd_band|LOWBATT_EN|CRYSTAL_EN|LOAD_CAP_12C0|cmd_bw;
