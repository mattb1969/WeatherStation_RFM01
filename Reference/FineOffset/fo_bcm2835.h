...
#define BSC_C_I2CEN            (1 << 15)    // 32768: 1000 0000 0000 0000
#define BSC_C_INTR             (1 << 10)    //  1024: 0000 0100 0000 0000
#define BSC_C_INTT             (1 << 9)     //   512: 0000 0010 0000 0000
#define BSC_C_INTD             (1 << 8)     //   256: 0000 0001 0000 0000
#define BSC_C_ST               (1 << 7)     //   128: 0000 0000 1000 0000
#define BSC_C_CLEAR            (1 << 4)     //    16: 0000 0000 0001 0000
#define BSC_C_READ             1            //     1: 0000 0000 0000 0001

#define START_READ             BSC_C_I2CEN|BSC_C_ST|BSC_C_CLEAR|BSC_C_READ
#define START_WRITE            BSC_C_I2CEN|BSC_C_ST

#define BSC_S_CLKT             (1 << 9)     //   512: 0000 0010 0000 0000
#define BSC_S_ERR              (1 << 8)     //   256: 0000 0001 0000 0000
#define BSC_S_RXF              (1 << 7)     //   128: 0000 0000 1000 0000
#define BSC_S_TXE              (1 << 6)     //    64: 0000 0000 0100 0000
#define BSC_S_RXD              (1 << 5)     //    32: 0000 0000 0010 0000
#define BSC_S_TXD              (1 << 4)     //    16: 0000 0000 0001 0000
#define BSC_S_RXR              (1 << 3)     //     8: 0000 0000 0000 1000
#define BSC_S_TXW              (1 << 2)     //     4: 0000 0000 0000 0100
#define BSC_S_DONE             (1 << 1)     //     2: 0000 0000 0000 0010
#define BSC_S_TA               1            //     1: 0000 0000 0000 0001
